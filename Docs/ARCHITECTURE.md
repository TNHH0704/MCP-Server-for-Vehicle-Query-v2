...
- Migrations run on startup or manually via `dotnet ef`

### Logging
- Console logging for Docker/cloud deployments
- File-based audit logs in `./logs/`
- Configurable log levels per category

### Health Checks
- Database connectivity check
- External API availability check
- Memory and token budget monitoring
